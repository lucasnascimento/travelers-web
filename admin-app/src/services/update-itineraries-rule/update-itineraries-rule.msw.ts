...
const updateItinerariesRuleData = {
  data: {
...
export const updateItinerariesRule = http.post(
  `${variables.API_BASE_URL}admin/itinerary/:id/rule/:rule_id`,
  () => HttpResponse.json({
    status: 200,
    ...updateItinerariesRuleData,
  })
)
